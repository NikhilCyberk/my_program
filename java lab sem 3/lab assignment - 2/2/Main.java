...
/*
 *  Implement two overloaded “multiply” methods in Vector class, one accepting a double element
* performing multiplication of a vector with a scalar, and the other one accepting another Vector
